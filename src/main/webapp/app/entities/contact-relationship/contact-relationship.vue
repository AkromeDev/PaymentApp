<template>
    <div>
        ...
        <div class="table-responsive" v-if="contactRelationships && contactRelationships.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="contactRelationship in contactRelationships"
                    ...
                    <td>
                        <span v-for="(user, i) in contactRelationship.users" :key="user.id">{{i > 0 ? ', ' : ''}}
                            {{user.id}}
                        </span>
                    </td>
                    <td class="text-right">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="payMyBuddyApp.contactRelationship.delete.question">Confirm delete operation</span></span>
